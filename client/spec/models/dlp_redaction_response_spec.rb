...
# Unit tests for CloudmersiveDlpApiClient::DlpRedactionResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DlpRedactionResponse' do
  before do
    # run before each test
    @instance = CloudmersiveDlpApiClient::DlpRedactionResponse.new
  end
  ...
  describe 'test an instance of DlpRedactionResponse' do
    it 'should create an instance of DlpRedactionResponse' do
      expect(@instance).to be_instance_of(CloudmersiveDlpApiClient::DlpRedactionResponse)
    end
  end
