...
# Unit tests for CloudmersiveDlpApiClient::DlpAudioDetectionResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DlpAudioDetectionResponse' do
  before do
    # run before each test
    @instance = CloudmersiveDlpApiClient::DlpAudioDetectionResponse.new
  end
  ...
  describe 'test an instance of DlpAudioDetectionResponse' do
    it 'should create an instance of DlpAudioDetectionResponse' do
      expect(@instance).to be_instance_of(CloudmersiveDlpApiClient::DlpAudioDetectionResponse)
    end
  end
