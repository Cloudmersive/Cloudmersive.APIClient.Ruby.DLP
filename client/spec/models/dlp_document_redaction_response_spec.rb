...
# Unit tests for CloudmersiveDlpApiClient::DlpDocumentRedactionResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DlpDocumentRedactionResponse' do
  before do
    # run before each test
    @instance = CloudmersiveDlpApiClient::DlpDocumentRedactionResponse.new
  end
  ...
  describe 'test an instance of DlpDocumentRedactionResponse' do
    it 'should create an instance of DlpDocumentRedactionResponse' do
      expect(@instance).to be_instance_of(CloudmersiveDlpApiClient::DlpDocumentRedactionResponse)
    end
  end
