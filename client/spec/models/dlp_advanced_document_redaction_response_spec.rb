...
# Unit tests for CloudmersiveDlpApiClient::DlpAdvancedDocumentRedactionResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DlpAdvancedDocumentRedactionResponse' do
  before do
    # run before each test
    @instance = CloudmersiveDlpApiClient::DlpAdvancedDocumentRedactionResponse.new
  end
  ...
  describe 'test an instance of DlpAdvancedDocumentRedactionResponse' do
    it 'should create an instance of DlpAdvancedDocumentRedactionResponse' do
      expect(@instance).to be_instance_of(CloudmersiveDlpApiClient::DlpAdvancedDocumentRedactionResponse)
    end
  end
  describe 'test attribute "redacted_document"' do
    it 'should work' do
  ...
  describe 'test attribute "pages_redacted"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
