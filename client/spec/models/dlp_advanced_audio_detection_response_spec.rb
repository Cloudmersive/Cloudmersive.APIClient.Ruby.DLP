...
# Unit tests for CloudmersiveDlpApiClient::DlpAdvancedAudioDetectionResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DlpAdvancedAudioDetectionResponse' do
  before do
    # run before each test
    @instance = CloudmersiveDlpApiClient::DlpAdvancedAudioDetectionResponse.new
  end
  ...
  describe 'test an instance of DlpAdvancedAudioDetectionResponse' do
    it 'should create an instance of DlpAdvancedAudioDetectionResponse' do
      expect(@instance).to be_instance_of(CloudmersiveDlpApiClient::DlpAdvancedAudioDetectionResponse)
    end
  end
