...
# Unit tests for CloudmersiveDlpApiClient::DlpDetectionResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DlpDetectionResponse' do
  before do
    # run before each test
    @instance = CloudmersiveDlpApiClient::DlpDetectionResponse.new
  end
  ...
  describe 'test an instance of DlpDetectionResponse' do
    it 'should create an instance of DlpDetectionResponse' do
      expect(@instance).to be_instance_of(CloudmersiveDlpApiClient::DlpDetectionResponse)
    end
  end
