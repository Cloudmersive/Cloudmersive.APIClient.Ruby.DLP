...
# Unit tests for CloudmersiveDlpApiClient::DlpAdvancedRedactionResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DlpAdvancedRedactionResponse' do
  before do
    # run before each test
    @instance = CloudmersiveDlpApiClient::DlpAdvancedRedactionResponse.new
  end
  ...
  describe 'test an instance of DlpAdvancedRedactionResponse' do
    it 'should create an instance of DlpAdvancedRedactionResponse' do
      expect(@instance).to be_instance_of(CloudmersiveDlpApiClient::DlpAdvancedRedactionResponse)
    end
  end
